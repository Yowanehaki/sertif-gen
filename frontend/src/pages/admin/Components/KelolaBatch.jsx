  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-lg w-full h-full flex flex-col">
      <div className="text-center mb-6">
        <div className="w-16 h-16 bg-gradient-to-r from-red-500 to-red-400 rounded-2xl flex items-center justify-center mx-auto mb-4">
      ...
      <div className="space-y-6">
        ...
        <form className="flex gap-2" onSubmit={handleAdd}>
          <div className="relative flex-1">
            ...
            <input
              type="text"
              className="w-full pl-10 pr-4 py-3 border-1 border-gray-500 rounded-xl focus:border-transparent transition-all duration-200"
          ...
          <button
            type="submit"
            className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-red-600 text-white px-6 py-3 rounded-xl font-medium transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
            Tambah
          </button>
        </form>
